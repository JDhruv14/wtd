...
function Particle({
  ...
  // Use useState with lazy initializer so the random values are
  // generated once on the server and then reused on the client,
  // avoiding SSR/client mismatches during hydration.
